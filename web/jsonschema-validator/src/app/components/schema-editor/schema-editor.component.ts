 ...
 * 
 * CodeMirror 6 based JSON Schema editor with syntax highlighting, line numbers,
 * bracket matching, and JSON validation with error indicators.
 * 
 * Source: docs/stories/3.3.story.md - Task 4
 */
@Component({
...
export class SchemaEditorComponent implements AfterViewInit, OnDestroy {
  ...
  @Input() initialContent: string = DEFAULT_SCHEMA;
